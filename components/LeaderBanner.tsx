...
export default function LeaderBanner({ usuario, puntaje, pctAciertos }: LeaderBannerProps) {
  return (
    <div className="rounded-xl bg-gradient-to-r from-gold to-gold-200 px-5 py-4 text-navy-800 shadow-gold flex items-center gap-3 flex-wrap">
      ...
      <p className="font-bold text-base sm:text-lg">
        Líder actual: <span className="underline decoration-2">{usuario}</span> con {puntaje} puntos
